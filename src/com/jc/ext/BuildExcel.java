...
public class BuildExcel extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(user==null||user.getUserid()<=0){
		    ...
		    //设置单元格内容
		    cell.setCellValue("金诚无卡消费-"+user.getUsername()+"商户消费记录表");
		    ...
		    //创建单元格并设置单元格内容
		    HSSFCell cell0=row2.createCell(0);cell0.setCellValue("消费账号");
		    HSSFCell cell1=row2.createCell(1);cell1.setCellValue("消费用户");
		    HSSFCell cell2=row2.createCell(2);cell2.setCellValue("消费金额"); 
		    HSSFCell cell3=row2.createCell(3);cell3.setCellValue("消费钱包");    
		    HSSFCell cell4=row2.createCell(4);cell4.setCellValue("消费日期");
		    HSSFCell cell5=row2.createCell(5);cell5.setCellValue("消费点");
		    HSSFCell cell6=row2.createCell(6);cell6.setCellValue("消费商户");
		    ...
		    if(consumes!=null&&consumes.size()>0){
		    	for (int i = 0; i <consumes.size(); i++) {
		    		...
		    		HSSFCell cel1=row.createCell(0);cel1.setCellValue(consumes.get(i).getClientid());
		    		HSSFCell cel2=row.createCell(1);cel2.setCellValue(consumes.get(i).getClientname());
		    		HSSFCell cel3=row.createCell(2);cel3.setCellValue(Double.valueOf(consumes.get(i).getCssum()));
		    		HSSFCell cel4=row.createCell(3);
		    		if(consumes.get(i).getWallettype().equals("5")){
		    			cel4.setCellValue("IC金诚币");
		    		}else if(consumes.get(i).getWallettype().equals("6")){
		    			cel4.setCellValue("IC现金");
		    		}else if(consumes.get(i).getWallettype().equals("7")){
		    			cel4.setCellValue("ID金诚币");
		    		}else if(consumes.get(i).getWallettype().equals("8")){
		    			cel4.setCellValue("ID现金");
		    		}
		    		
		    		HSSFCell cel5=row.createCell(4);cel5.setCellValue(consumes.get(i).getMaketime());
		    		HSSFCell cel6=row.createCell(5);cel6.setCellValue(consumes.get(i).getCsmerchat());
		    		HSSFCell cel7=row.createCell(6);cel7.setCellValue(consumes.get(i).getMername());
